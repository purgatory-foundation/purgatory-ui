            ...
            <div className="flex items-end">
              ...
              >
                ...
                <div className="pointer-events-none fixed inset-x-0 bottom-0 sm:flex sm:justify-center sm:px-6 sm:pb-5 lg:px-8">
                  <div className="pointer-events-auto flex items-center justify-between gap-x-6 bg-gray-900 px-6 py-2.5 sm:py-3 sm:pl-4 sm:pr-3.5">
                    <p className="flex text-sm text-white">
                      <XCircleIcon className="h-5 w-5 text-red-400 mr-1" aria-hidden="true" />{''}<strong className="font-semibold mr-1">Error -{'>'}</strong>{''}{message}
                    </p>
